...
extern float _max30100_ir_dcremoval[16];
extern float _max30100_red_dcremoval[16];
extern float _max30100_ir_meandiff[16];
extern float _max30100_red_meandiff[16];
extern float _max30100_ir_butterworth[16];
extern float _max30100_red_butterworth[16];
...
void MAX30100_PlotBothToUART(UART_HandleTypeDef *uuart, float *samplesRed, float *samplesIr, uint8_t sampleSize);
