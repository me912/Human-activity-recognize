...
#define AI_HAR_ORIGIN_MODEL_NAME   "modelv7_2"
...
#define AI_HAR_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 128, 1, 9, 1, NULL), \
}
...
#define AI_HAR_IN_1_HEIGHT      (128)
#define AI_HAR_IN_1_CHANNEL     (9)
#define AI_HAR_IN_1_SIZE        (128 *  9)
#define AI_HAR_IN_1_SIZE_BYTES  (AI_HAR_IN_1_SIZE * 4)
...
#define AI_HAR_OUT_1_CHANNEL     (6)
#define AI_HAR_OUT_1_SIZE        (6)
#define AI_HAR_OUT_1_SIZE_BYTES  (AI_HAR_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_HAR_N_NODES (9)
